        ...
        case "video":
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<video>").append(
                formats.map(y=>{
                    ...
                    mediaquery != undefined?tag = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<source>",{src:`media${e.data("url")}.${mediaquery}.${y}`,type:`video/${y}`}):tag = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<source>",{src:`media${e.data("url")}.${y}`,type:`video/${y}`});
                    return tag;
                })                
            ).append(
